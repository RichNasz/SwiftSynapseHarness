# Contributing to SwiftSynapseHarness

Thank you for your interest in contributing to SwiftSynapseHarness!
...
`runtime`, `tools`, `hooks`, `permissions`, `recovery`, `streaming`, `llm`, `ui`, `tests`, `docs`, `specs`

### Examples

```
feat(tools): add batch dispatch to ToolRegistry
fix(hooks): correct event ordering in AgentHookPipeline
test(recovery): add Swift Testing tests for RecoveryChain
spec(hooks): add hook cancellation event to spec
...
- [ ] New features have Swift Testing tests
